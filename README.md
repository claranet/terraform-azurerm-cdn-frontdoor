...
| security\_policies | CDN FrontDoor Security policies configurations. | <pre>list(object({<br>    name                 = string<br>    custom_resource_name = optional(string)<br>    firewall_policies = list(object({<br><br>    }))<br>  }))</pre> | `[]` | no |
